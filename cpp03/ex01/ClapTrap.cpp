...
/*   Updated: 2022/12/06 17:18:54 by jiwolee          ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap( std::string name )
	...
	std::cout << "ClapTrap : Param Constructor called : " << this->_name << std::endl;
}
...
ClapTrap::~ClapTrap( void ){
	std::cout << "ClapTrap : Destrutor called : " << this->_name << std::endl;
}
...
void	ClapTrap::takeDamage( unsigned int amount ){
	if (this->_hit_points <= amount || this->_energy_points == 0)
	{
		std::cout << "ClapTrap " << this->_name << " is dead, can't do anything.." << std::endl;
		return ;
	}
